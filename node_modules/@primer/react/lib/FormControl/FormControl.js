...
const FormControl = ({
  ...
  return /*#__PURE__*/_react.default.createElement(_slots.Slots, {
    ...
    return isChoiceInput ? /*#__PURE__*/_react.default.createElement(_.Box, {
      display: "flex",
    ...
    }, _react.default.Children.toArray(children).filter(child => /*#__PURE__*/_react.default.isValidElement(child) && !expectedInputComponents.some(inputComponent => child.type === inputComponent)), slots.Label, /*#__PURE__*/_react.default.isValidElement(InputComponent) && /*#__PURE__*/_react.default.cloneElement(InputComponent, {
      id,
      required,
      disabled,
      validationStatus,
      ['aria-describedby']: [validationMessageId, captionId].filter(Boolean).join(' ')
    }), validationChild && /*#__PURE__*/_react.default.createElement(_ValidationAnimationContainer.default, {
      show: true
