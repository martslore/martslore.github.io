...
const CheckboxOrRadioGroup = ({
  ...
  const expectedInputComponents = [_.Checkbox, _.Radio];
  ...
  const checkIfOnlyContainsChoiceInputs = () => {
    ...
    return Boolean(_react.default.Children.toArray(formControlComponentChildren).find(child => expectedInputComponents.some(inputComponent => /*#__PURE__*/_react.default.isValidElement(child) && child.type === inputComponent)));
  };
